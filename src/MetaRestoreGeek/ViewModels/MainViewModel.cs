...
{
    private readonly string? _exifToolPath = ExifToolTools.FindExifTool();
    ...
    public string ExifToolMissingMessage =>
        "MetaRestoreGeek needs exiftool to write dates and locations back into your photos, and " +
        "does not bundle a copy. Install it from " + ExifToolTools.OfficialSiteUrl +
        " and make sure exiftool.exe is on your PATH, then restart MetaRestoreGeek.";
